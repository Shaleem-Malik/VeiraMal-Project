...
export default function CrmDashboard({ match }) {
  ...
  return (
    <div className="modern-dashboard-wrapper">
      <Helmet>
        ...
        <meta name="description" content="CEO Dashboard for Final Analyses" />
      </Helmet>

      <div className="dashboard-header">
        <PageTitleBar title={<IntlMessages id="CEO Dashboard" />} match={match} />
